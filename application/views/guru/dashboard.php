            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url('dosen/profile_dosen') ?>">Profile Dosen</a>
                        <a class="collapse-item" href="<?php echo base_url('dosen/absen') ?>">Absen</a>
                        <a class="collapse-item" href="<?php echo base_url('dosen/tugas') ?>">Tugas</a>
                        <a class="collapse-item" href="<?php echo base_url('dosen/krs') ?>">KRS</a>
                        <a class="collapse-item" href="<?php echo base_url('dosen/jadwal_kuliah') ?>">Jadwal Kuliah</a>
                    </div>
                </div>
            </li>
