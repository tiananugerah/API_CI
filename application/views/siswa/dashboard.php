<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url('mahasiswa/profile_mahasiswa') ?>">Profile Mahasiswa</a>
                        <a class="collapse-item" href="<?php echo base_url('mahasiswa/upload_tugas') ?>">Upload Tugas</a>
                        <a class="collapse-item" href="<?php echo base_url('mahasiswa/absen') ?>">Absen</a>
                        <a class="collapse-item" href="<?php echo base_url('mahasiswa/nilai') ?>">Nilai</a>
                        <a class="collapse-item" href="<?php echo base_url('mahasiswa/jadwal_kuliah') ?>">Jadwal Kuliah</a>
                        <a class="collapse-item" href="<?php echo base_url('mahasiswa/krs') ?>">KRS</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('login/auth') ?>">
...
<div class="container-fluid">
    <div class="alert alert-success" role="alert">
        Selamat datang <strong><?php echo $username ?></strong>, Anda login sebagai <strong><?php echo $level ?></strong>
    </div>
